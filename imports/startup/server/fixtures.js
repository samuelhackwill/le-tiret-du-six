...
initiateWords = function (_env) {
  ...
  if (__env) {
    ...
    Words.insert({
      env: "Prod",
      data: [{ name: "soudain", text: "c'est le mot préféré des de samuel quand il a plus d'idées", citation: "et soudain, la webapp était plantée.", author: "Albert Einstein (Apocryphe)", harvestedLetters: [] }],
    })
...
initiateHighScore = function () {
  pastScores = [
    ...
    {
      name: "Fives R1",
      date: Date.parse("2023-1-12T10:30:00"),
      peepCount: 52,
      entreePublic: 163,
      ping: 1443,
    },
    ...
    {
      name: "Fives R2",
      date: Date.parse("2023-1-12T19:30:00"),
      peepCount: 57,
      entreePublic: 305,
      ping: 1241,
    },
